...
<div class="p-service-tab p-service-content01" id="js-tab">
  <div class="p-service-tab__nav l-inner">
    ...
    <a href="<?php echo home_url(); ?>/movie" class="p-service-tab__nav-item is-active contents02" data-nav="1">動画でみる活用事例</a>
  ...
  <div class="p-service-tab__content" data-content="0">
    <!-- <div class="panel"> -->
    <div class="panel__title" id="movie">
      <figure class="panel__logo">
        <img src="<?php echo get_template_directory_uri(); ?>/images/common/logo-movie02.png" alt="動画でみる活用事例のロゴ">
      </figure>
      <h3>動画でみる活用事例</h3>
    </div>
    <!-- カード -->
    <div class="p-post-cards video-cards">
      ...
      <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
          ...
          <div class="p-post-card">
            ...
            <h4 class="p-post-card__title"><?php the_field('title'); ?></h4>
            <p class="p-post-card__text"><?php the_field('text'); ?></p>
