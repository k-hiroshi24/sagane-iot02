...
<main>
  ...
  <div class="opening-animation js-opening">
    <figure class="js-logo">
      <img src="<?php echo get_template_directory_uri(); ?>/images/common/sagane-logo-white.png" alt="">
    </figure>
  </div>
  <!-- mv -->
  <section class="l-mv p-mv ">
    <div class="p-mv__inner">
      <div class="p-mv__title-box">
        <img class="p-mv__logo" src="<?php echo get_template_directory_uri(); ?>/images/common/sagane-logo-white.png" alt="">
      ...
      <picture class="p-mv__img">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/images/common/mv-img-sp.jpg" alt="">
        <!-- banner -->
  ...
  <section class="l-concept p-concept">
    <div class="p-concept__inner">
      ...
      <div class="p-concept__explanation">
        <img class="p-concept__logo" src="<?php echo get_template_directory_uri(); ?>/images/common/sagane-logo-title.png" alt="">
        <img class="p-concept__illustrated" src="<?php echo get_template_directory_uri(); ?>/images/common/item-irasuto.png" alt="">
      ...
      <div class="p-item__btn-wrap">
        <div class="p-item__explanation">
          <div class="c-item-text--top">
            <figure class="large">
              <img src="<?php echo get_template_directory_uri(); ?>/images/common/item-logo01.png" alt="">
            </figure>
            ...
            <div class="c-btn c-item-text__more-btn">
              <a href="<?php echo home_url(); ?>/scada">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item-btn01.png" alt="" />
              </a>
            </div>
          </div>
          <!-- 稼働監視 -->
          <ul class="p-item__modal grid ">
            <li class="item01">
              <a href="" class="js-open-btn" data-target=".target-modal01">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item01-2.png" alt="">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item01.png" alt="">
              </a>
            </li>
            <!-- モーダルアイテム -->
            <div class="p-modal-item target-modal01">
              <figure class="p-modal-item__content">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/modal-item01.png" alt="">
            ...
            <!-- end -->
            <li class="item01">
              <img src="<?php echo get_template_directory_uri(); ?>/images/common/item05.png" alt="">
              <img src="" alt="">
            </li>
            <!-- 設備点検 -->
            <li class="item01">
              <a href="" class="js-open-btn" data-target=".target-modal02">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item02-2.png" alt="">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item02.png" alt="">
              </a>
            </li>
            <!-- モーダルアイテム -->
            <div class="p-modal-item target-modal02">
              <figure class="p-modal-item__content">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/modal-item02.png" alt="">
            ...
            <li class="item01">
              <a href="" class="js-open-btn" data-target=".target-modal03">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item06-2.png" alt="">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item06.png" alt="">
              </a>
            </li>
            <!-- モーダルアイテム -->
            <div class="p-modal-item target-modal03">
              <figure class="p-modal-item__content">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/modal-item03.png" alt="">
            ...
            <li class="item01">
              <a href="" class="js-open-btn" data-target=".target-modal04">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item03-3.png" alt="">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item03.png" alt="">
              </a>
            </li>
            <!-- モーダルアイテム -->
            <div class="p-modal-item target-modal04">
              <figure class="p-modal-item__content">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/modal-item04.png" alt="">
            ...
            <!-- end -->
            <li class="item01">
              <img src="<?php echo get_template_directory_uri(); ?>/images/common/item07.png" alt="">
              <img src="" alt="">
            </li>
            <li class="item01">
              <img src="<?php echo get_template_directory_uri(); ?>/images/common/item04.png" alt="">
              <img src="" alt="">
            </li>
          </ul>
        </div>
        ...
        <div class="p-item__explanation green">
          <div class="c-item-text--top">
            <figure class="small">
              <img src="<?php echo get_template_directory_uri(); ?>/images/common/item-logo02.png" alt="">
            </figure>
            <h3>品質トレサビシステム</h3>
            ...
            <div class="c-btn c-item-text__more-btn">
              <a href="<?php echo home_url(); ?>/tolesabi">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item-btn02.png" alt="" />
              </a>
            </div>
          </div>
          <ul class="p-item__btns">
            <li class="item02">
              <img src="<?php echo get_template_directory_uri(); ?>/images/common/item22.png" alt="">
              <img src="" alt="">
            </li>
            <li class="item02">
              <img src="<?php echo get_template_directory_uri(); ?>/images/common/itme23.png" alt="">
              <img src="" alt="">
            </li>
            <!-- ゲートチェック -->
            <li class="item02">
              <a href="" class="js-open-btn" data-target=".target-modal05">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item23-2.png" alt="">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item21.png" alt="">
              </a>
            </li>
            <!-- モーダルアイテム -->
            <div class="p-modal-item target-modal05">
              <figure class="p-modal-item__content">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/modal-item05.png" alt="">
            ...
            <!-- end -->
            <li class="item02">
              <img src="<?php echo get_template_directory_uri(); ?>/images/common/item24.png" alt="">
              <img src="" alt="">
            </li>
          </ul>
        </div>
        ...
        <div class="p-item__explanation">
          <div class="c-item-text--top">
            <figure class="small">
              <img src="<?php echo get_template_directory_uri(); ?>/images/common/item-logo03.png" alt="">
            </figure>
            <h3>⾃動化関連装置</h3>
            <p class="mt-large">
          ...
          <ul class="p-item__btns">
            ...
            <li class="item03">
              <a href="" class="js-open-btn" data-target=".target-modal06">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item31-2.png" alt="">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item31.png" alt="">
              </a>
            </li>
            <!-- モーダルアイテム -->
            <div class="p-modal-item target-modal06">
              <figure class="p-modal-item__content">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/modal-item06.png" alt="">
            ...
            <li class="item03">
              <a href="" class="js-open-btn" data-target=".target-modal07">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item32-3.png" alt="">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item32.png" alt="">
              </a>
            </li>
            <!-- モーダルアイテム -->
            <div class="p-modal-item target-modal07">
              <figure class="p-modal-item__content">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/modal-item07.png" alt="">
            ...
            <!-- end -->
            <li class="item03">
              <img src="<?php echo get_template_directory_uri(); ?>/images/common/item33.png" alt="">
              <img src="" alt="">
            </li>
            <!-- 検査装置 -->
            <li class="item03">
              <a href="" class="js-open-btn" data-target=".target-modal08">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item34-2.png" alt="">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/item34.png" alt="">
              </a>
            </li>
            <!-- モーダルアイテム -->
            <div class="p-modal-item target-modal08">
              <figure class="p-modal-item__content">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/modal-item08.png" alt="">
    ...
    <div class="p-service__support-wrap">
      <div class="p-service__support-item">
        <div class="p-service__logo">
          <img src="<?php echo get_template_directory_uri(); ?>/images/common/sagane-logo-green.png" alt="">
        </div>
        <h3>導入支援「無償サポート」</h3>
      ...
      <div class="p-service__support-item ">
        <div class="p-service__logo">
          <img src="<?php echo get_template_directory_uri(); ?>/images/common/sagane-logo-blue.png" alt="">
        </div>
        <h3>運営支援「サポートサービス」</h3>
      ...
      <div class="p-know-how__cards">
        <div class="p-know-how__card c-card">
          <div class="c-card__img ">
            <img src="<?php echo get_template_directory_uri(); ?>/images/common/top-card-img01.jpg" alt="">
          </div>
        ...
        <div class="p-know-how__card c-card">
          <div class="c-card__img ">
            <img src="<?php echo get_template_directory_uri(); ?>/images/common/top-card-img02.jpg" alt="">
          </div>
          <div class="p-know-how__card-body c-card__body">
        ...
        <div class="p-know-how__card c-card">
          <div class="c-card__img ">
            <img src="<?php echo get_template_directory_uri(); ?>/images/common/top-card-img03.jpg" alt="">
          </div>
          <div class="p-know-how__card-body c-card__body">
